                        ...
                        <div class="loginRegisterDiv w-100 p-0">
                            <ul class="nav nav-tabs w-100">
                                <li class="nav-item w-50">
                                    <a class="this nav-link text-center active" href="index.jsp" id="login">Login</a>
                                </li>
                                <li class="nav-item w-50">
                                    <a class="this nav-link text-center navbarColor" href="register.jsp" id="register">Register</a>
                                </li>
                            </ul>
